...
const ControlDrodeUsingEeg = () => {

 

  const {title,authors,contributors,description,studydesign,background,research_questions} = projectList[4]
...
export default ControlDrodeUsingEeg
